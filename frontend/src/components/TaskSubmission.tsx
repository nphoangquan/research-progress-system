...
export default function TaskSubmission({ taskId, onSubmissionSuccess, currentSubmission }: TaskSubmissionProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          ...
          disabled={submitTaskMutation.isPending || isSubmitting}
