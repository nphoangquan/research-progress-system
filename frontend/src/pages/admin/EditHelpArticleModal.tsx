...
interface EditHelpArticleModalProps {
  isOpen: boolean;
  onClose: () => void;
  article: HelpArticle;
  categories: string[];
...
export default function EditHelpArticleModal({
  isOpen,
  onClose,
  article,
  categories,
}: EditHelpArticleModalProps) {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      const response = await api.patch(`/help/${article.id}`, data);
    ...
    onError: (error: any) => {
      const errorMessage = getErrorMessage(error, 'Không thể cập nhật bài viết');
